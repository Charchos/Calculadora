// calculadora2.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
#include <string>
...

{
...

	{
		...
		cout << LIGHT_CYANF << BLUE << "--------------------------------------------------------------" DEFAULT0 << endl;

		cout << LIGHT_CYANF << BLUE << BLINK_ON << "||    C A L C U L A D O R A                              ||" DEFAULT0 << endl;
		...
		cout << LIGHT_CYANF << BLUE << "||                       CREADOR:                           ||" DEFAULT0 << endl;

		cout << LIGHT_CYANF << BLUE << "||             CARLOS RODOLFO FLORES VILLALVAZO             ||" DEFAULT0 << endl;

		cout << LIGHT_CYANF << BLUE << "||                   BACHILLERATO NO.8                      ||" DEFAULT0 << endl;

		cout << LIGHT_CYANF << BLUE << "||                         3B                               ||" DEFAULT0 << endl;

		cout << LIGHT_CYANF << BLUE << "||----------------------------------------------------------||" DEFAULT0 << endl;

		cout << LIGHT_CYANF << BLUE << "||                                                          ||" DEFAULT0 << endl;

		cout << LIGHT_CYANF << BLUE << "|| " DEFAULT0 << LIGHT_CYANF << RED << "bienvenido a la calculadora:" DEFAULT0 << LIGHT_CYANF << BLUE << "             ||" DEFAULT0 << endl;
